...
}, 0);  // No delay for temperature (starts immediately)

// Fetch Humidity every 10 seconds, but start after 3 seconds
setTimeout(function () {
  setInterval(function () {
    var xhttp = new XMLHttpRequest();
    xhttp.onreadystatechange = function () {
...
}, 3000);  // 3-second delay for first humidity request

// Fetch Moisture every 10 seconds, but start after 6 seconds
setTimeout(function () {
  setInterval(function () {
    var xhttp = new XMLHttpRequest();
    xhttp.onreadystatechange = function () {
